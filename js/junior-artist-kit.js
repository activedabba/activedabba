$(document).ready(function() {
    ...
    $.getJSON("junior-artist-kit.json",
        function(data) {
            var img_container = '';

            img_container += '<div class="col-lg-3 col-sm-3 mb-2">'
            img_container += '<a class="portfolio-box" target="_blank" href="' + data.img1 + '">'
            img_container += '<img class="img-fluid" src="' + data.img1 + '">'
            img_container += '</a>'
            img_container += '</div>'
            img_container += '<div class="col-lg-3 col-sm-3 mb-2">'
            img_container += '<a class="portfolio-box" target="_blank" href="' + data.img2 + '">'
            img_container += '<img class="img-fluid" src="' + data.img2 + '">'
            img_container += '</a>'

            // pro_duct += '<a class="portfolio-box" target="_blank" href="' + data.img1 + '"><button>view</button></a>'
            ...
            img_container += '</div>'
            img_container += '<div class="col-lg-3 col-sm-3 mb-2">'
            img_container += '<a class="portfolio-box" target="_blank" href="' + data.img3 + '">'
            img_container += '<img class="img-fluid" src="' + data.img3 + '">'
            img_container += '</a>'
            img_container += '</div>'
            img_container += '<div class="col-lg-3 col-sm-3 mb-2">'
            img_container += '<a class="portfolio-box" target="_blank" href="' + data.img4 + '">'
            img_container += '<img class="img-fluid" src="' + data.img4 + '">'
            img_container += '</a>'
            img_container += '</div>'
            img_container += '<div class="col-lg-3 col-sm-3 mb-2">'
            img_container += '<a class="portfolio-box" target="_blank" href="' + data.img5 + '">'
            img_container += '<img class="img-fluid" src="' + data.img5 + '">'
            img_container += '</a>'
            img_container += '</div>'
            img_container += '<div class="col-lg-3 col-sm-3 mb-2">'
            img_container += '<a class="portfolio-box" target="_blank" href="' + data.img6 + '">'
            img_container += '<img class="img-fluid" src="' + data.img6 + '">'
            img_container += '</a>'
            img_container += '</div>'
            img_container += '<div class="col-lg-3 col-sm-3 mb-2">'
            img_container += '<a class="portfolio-box" target="_blank" href="' + data.img7 + '">'
            img_container += '<img class="img-fluid" src="' + data.img7 + '">'
            img_container += '</a>'
            img_container += '</div>'
            img_container += '<div class="col-lg-3 col-sm-3 mb-2">'
            img_container += '<a class="portfolio-box" target="_blank" href="' + data.img8 + '">'
            img_container += '<img class="img-fluid" src="' + data.img8 + '">'
            img_container += '</a>'
            img_container += '</div>'
            img_container += '<div class="col-lg-3 col-sm-3 mb-2">'
            img_container += '<a class="portfolio-box" target="_blank" href="' + data.img9 + '">'
            img_container += '<img class="img-fluid" src="' + data.img9 + '">'
            img_container += '</a>'
            img_container += '</div>'
            img_container += '<div class="col-lg-3 col-sm-3 mb-2">'
            img_container += '<a class="portfolio-box" target="_blank" href="' + data.img10 + '">'
